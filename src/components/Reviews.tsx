...
export default function Reviews() {
  ...
  return (
    <section className="py-24 px-6 bg-black border-b-8 border-black text-white">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        
        {/* BLOCO DA NOTA GIGANTE */}
        <div className="card-brutal bg-white p-8 rounded-2xl flex flex-col items-center justify-center text-center w-full lg:w-96 shrink-0 border-4 border-black shadow-[8px_8px_0px_0px_rgba(255,204,0,1)] text-black">
        ...
        <div className="flex-1 text-center lg:text-left space-y-6">
          <div className="inline-flex items-center gap-2 bg-yellow-400 text-black border-4 border-yellow-400 font-black text-xs uppercase tracking-widest px-4 py-1.5 shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
            <Users size={16} className="text-black" /> Comunidade Ativa
          </div>
