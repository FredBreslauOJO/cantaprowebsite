  ...
  return (
    <section id="pricing" className="py-24 px-6 bg-white border-b-8 border-black">
      <div className="max-w-7xl mx-auto">
        ...
        {/* CHAMADA DA MATRIZ DINÂMICA COMPLETA E RESPONSIVA */}
        <FeatureMatrix />

        {/* CONTAINER DOS CARDS COM INFORMAÇÕES REVISADAS E CORRIGIDAS */}
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-stretch mt-16">
          ...
          <div className="card-brutal flex flex-col justify-between bg-white text-black border-4 border-black rounded-2xl">
            <div>
              ...
              <ul className="space-y-4 mb-8 font-bold text-base text-gray-800">
                ...
                <li className="flex items-center gap-3">✓ Impressão de Roteiros</li>
                <li className="flex items-center gap-3">✓ Links Públicos de Palco</li>
              </ul>
            </div>
            <a href="https://app.canta.pro" className="btn-brutal-outline text-center text-lg w-full py-3 rounded-xl mt-auto">
              Começar Grátis
            </a>
          </div>
          ...
          <div className="card-brutal flex flex-col justify-between bg-white text-black border-4 border-black rounded-2xl">
            <div>
              ...
              <ul className="space-y-4 mb-8 font-bold text-base text-gray-800">
                <li className="flex items-center gap-3">✓ Músicas e Setlists Ilimitados</li>
                <li className="flex items-center gap-3">✓ Busca Online Global (LRCLIB)</li>
                <li className="flex items-center gap-3">✓ Importação Automática Timecode</li>
                <li className="flex items-center gap-3">✓ Instalação Completa Offline (PWA)</li>
              </ul>
            </div>
            <a href="https://app.canta.pro" className="btn-brutal-outline text-center text-lg w-full py-3 rounded-xl mt-auto">
              Assinar Basic
          ...
          <div className="card-brutal flex flex-col justify-between !bg-black !text-white border-4 border-black relative shadow-[12px_12px_0px_0px_rgba(255,204,0,1)] rounded-2xl">
            <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-yellow-400 text-black text-xs font-black uppercase tracking-widest py-2 px-6 border-4 border-black rounded-full shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] whitespace-nowrap z-20">
              Mais Escolhido
            </div>
            <div className="mt-4">
              ...
              <ul className="space-y-4 mb-8 font-bold text-base text-gray-200">
                ...
                <li className="flex items-center gap-3"><span className="text-yellow-400">✓</span> Modo Banda (Telas Sincronizadas)</li>
                <li className="flex items-center gap-3"><span className="text-yellow-400">✓</span> Auto-Play de Palco Sincronizado</li>
              </ul>
            </div>
            <a href="https://app.canta.pro" className="btn-brutal text-center text-lg w-full py-3 !bg-white !text-black hover:!bg-yellow-400 border-none shadow-none rounded-xl mt-auto">
              Assinar Pro
            </a>
          </div>
